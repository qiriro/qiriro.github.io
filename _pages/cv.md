...
March 2018 
:   **Oklahoma Christian University**, Oklahoma City, USA
    - **Graduate Teaching Assistant**, Department of Electrical and Computer Engineering

:   **Oklahoma Christian University**, Oklahoma City, USA
    - **Peer mentor**, at Oklahoma Christian University's [Bridge program](https://www.oc.edu/academics/student-success/bridge-program)
  
**Technical qualifications**
------
- **Programming languages** **C#**, C, C++, Julia, Java, **Python**, Kotlin, **MATLAB**, LaTeX, Octave, PowerShell
- **Web development** HTML, CSS, Bootstrap, XML, XSLT, Typescript, Javascript, Angular, React, **ASP.NET MVC & Razor Pages**, Blazor WEB API, experience in .NET Framework 4.6/4.5/4.0/3.5 and .NET Core and Microsoft SQL Server
- **Embedded Hardware Platforms** PIC16/18/24/32, MSP430, Atmel AVR, TI TM4C123, ESP8266NodeMCU, ESP32, STM32
- **Interfaces & Peripherals** LCD, FPGA, Timers,Flash memory, Motor,Sensors, EEPROM,
- **IoT Technology Domains** Wireless Sensor Networks for smart devices, IoT Gateways & Devices, Hardware & Software co-design, RTOS,  Embedded software development
- **Development tools** IntelliJ Idea, PyCharm, Eclipse, Visual Studio, VS Code, MPLab Maven,Keil, uVision, Atmel Studio
- **CAD tools** ORCAD P-Spice, Multisim,Proteus VSM, Eagle Layout Editor
- **Others** Real-time embedded system, FreeRTOS, HDL (Verilog), OOP & Design patterns, TDD, Predictive Analysis, Statistical Modeling, Quantitative Analysis, Web Scraping,DevOps, Familiarity with android app development
